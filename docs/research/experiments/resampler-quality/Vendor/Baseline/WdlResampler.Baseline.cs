// PRISTINE, UNMODIFIED copy of NAudio's WdlResampler -- the measurement baseline.
//
// This file exists so the harness can measure the before/after of ClipShift's allocation
// fix against the real thing rather than assert it from reading the code. It is NOT the
// copy ClipShift ships; that is ../WdlResampler.cs. Nothing outside the allocation
// baseline test may reference this namespace.
//
// Fetched verbatim 2026-08-18 from
// https://raw.githubusercontent.com/naudio/NAudio/master/NAudio.Core/Dsp/WdlResampler.cs
// The only edit is the namespace, so the two copies can coexist in one assembly.
...
namespace ClipShift.Audio.Resampling.Baseline
{
    /// <summary>
